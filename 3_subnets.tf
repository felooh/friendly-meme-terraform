...
resource "aws_subnet" "web-private-a" {
  ...
  availability_zone       = "${var.aws_region}a"
  tags = {
    Name = "skillsync-web-private-subnetA"
  }
}
...
resource "aws_subnet" "web-private-b" {
  ...
  tags = {
    Name = "skillsync-web-private-subnetB"
  }
}
...
resource "aws_subnet" "app-private-a" {
  ...
  availability_zone       = "${var.aws_region}a"
  tags = {
    Name = "skillsync-app-private-subnetA"
  }
}
...
resource "aws_subnet" "app-private-b" {
  ...
  availability_zone       = "${var.aws_region}a"
  tags = {
    Name = "skillsync-app-private-subnetB"
  }
}
...
resource "aws_subnet" "bastion-public-a" {
  ...
  availability_zone       = "${var.aws_region}b"
  tags = {
    Name = "skillsync-bastion-public-subnetA"
  }
}