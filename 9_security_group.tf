...
resource "aws_security_group" "web-elb-security-group" {
  name        = "skillsync-web-elb-public-security-group"
...
resource "aws_security_group" "web-app-security-group" {
  name        = "skillsync-web-app-private-security-group"
  ...
  tags = {
    Name = "skillsync-web-private-security-group"
  }
}
...
resource "aws_security_group" "bastion-security-group" {
  name        = "skillsync-bastion-public-security-group"
